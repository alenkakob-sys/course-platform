...
// Після публікації на GitHub Pages встановіть сюди реальну адресу,
// напр. https://username.github.io/course-platform
export const SITE_URL = 'https://username.github.io/course-platform';

// Адреса окремого міні-проєкту на Netlify, який обробляє Telegram
// (єдина частина, що лишається на Netlify — див. INSTRUKTSIYA.md).
export const FUNCTIONS_URL = 'https://ВАШ-FUNCTIONS-ПРОЄКТ.netlify.app/.netlify/functions';
